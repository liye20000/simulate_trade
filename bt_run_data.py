...
if __name__ == '__main__':
    ...
    # 准备数据
    csv_file = 'data/BTCUSDT-2024-to-8-5m.csv'
    # 无日期
    from_dt  = None
    to_dt    = None
    # 经典数据:
    ...
    if optimize == True:
        ...
        # print("==================保存图片中======================")
        # fig = cerebro.plot(volume=False,start=datetime.datetime(2024, 1, 1, 0, 0, 0), end=datetime.datetime(2024, 10, 5, 0, 0, 0))[-1][0]  # style = 'candle'
